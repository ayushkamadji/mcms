...
// IMPORT APPS
const system = {
  server, db, Router, Model, core: {}, apps: {}, common: {}
}
const access = require("./core/access")(system)
const setup = require("./core/setup")(system)
const web = require("./common/web")(system)
const dashboard = require("./apps/dashboard")(system)
const blog = require("../apps/blog")(system)
const statics = require("./apps/static")(system)
...
server.use(setup.middleware)

// AND APPS
server.use(access.web.api)
server.use(setup.web.router)
server.use(dashboard.web.router)
server.use(blog.web.router)
server.use(statics.web.router)
